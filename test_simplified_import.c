...
int main() {
    ...
    printf("%s\n", "=== Prueba Simplificada del Sistema de Módulos ===");
    ...
    double result2 __attribute__((unused)) =     math_lib_multiply(    0    ,     a    ,     b    )    ;
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "math_lib.multiply(10, 5) = "        ,         result2        );
        printf("%s\n", _print_buffer);
    }
    ...
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "Resultado de operaciones concatenadas: "        ,         c        );
        printf("%s\n", _print_buffer);
    }
