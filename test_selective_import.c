...
int main() {
    ...
    printf("%s\n", "=== Prueba de Importaciones Avanzadas ===");
    ...
    // Importando módulo: math_lib
    // Alias para el módulo: m
    math_lib_Module* m = &math_lib;
    double result2 __attribute__((unused)) =     m_multiply(    0    ,     a    ,     b    )    ;
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "m.multiply(10, 5) = "        ,         result2        );
        printf("%s\n", _print_buffer);
    }
    // Importando módulo: math_lib
    // Imports selectivos como funciones wrapper
    // Función wrapper para add (alias: add)
    double add(double a, double b) {
        return math_lib.add(0, a, b);
    }
    // Función wrapper para subtract (alias: subtract)
    double subtract(double a, double b) {
        return math_lib.subtract(0, a, b);
    }
    double result3 __attribute__((unused)) =     add(    a    ,     b    )    ;
    double result4 __attribute__((unused)) =     subtract(    a    ,     b    )    ;
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "add(10, 5) = "        ,         result3        );
        printf("%s\n", _print_buffer);
    }
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "subtract(10, 5) = "        ,         result4        );
        printf("%s\n", _print_buffer);
    }
    // Importando módulo: math_lib
    // Imports selectivos como funciones wrapper
    // Función wrapper para multiply (alias: mul)
    double mul(double a, double b) {
        return math_lib.multiply(0, a, b);
    }
    // Función wrapper para divide (alias: div)
    double div(double a, double b) {
        return math_lib.divide(0, a, b);
    }
    double result5 __attribute__((unused)) =     mul(    a    ,     b    )    ;
    double result6 __attribute__((unused)) =     div(    a    ,     b    )    ;
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "mul(10, 5) = "        ,         result5        );
        printf("%s\n", _print_buffer);
    }
    {
        char _print_buffer[1024];
        sprintf(_print_buffer, "%s%g",         "div(10, 5) = "        ,         result6        );
        printf("%s\n", _print_buffer);
    }
